...
void ShowBuyScreen(SDL_Window* window, PlayerData* player);
...
void PlayLevel(SDL_Window* window, PlayerData* player,int level);
...
void ShowBuyScreen(SDL_Window* gWindow, PlayerData* player) {
	while (true) {
